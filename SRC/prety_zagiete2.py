...
ROZST_S_HAKOW.grid(row=32, columnspan=3, sticky="w")

ROZST_ABST = Label(root, justify="left", text=" - ")
ROZST_ABST.grid(row=33, columnspan=3, sticky="w")
...
ODSTEP_4.grid(row=1, columnspan=3, sticky="w")
...
ODSTEP_5.grid(row=13, columnspan=3, sticky="w")
